...
sumIndexHigherARA = sum(priceRetHigherARA,2);
indexHigherARA = sumIndexHigherARA(sumIndexHigherARA~=0);


% Identify symbols with daily ret lower than ARB limit
priceRetHigherARB = closePriceRetVar < -priceRetLimit;
sumindexLowerARB = sum(priceRetHigherARB,2);
indexLowerARB = sumindexLowerARB(sumindexLowerARB~=0);
